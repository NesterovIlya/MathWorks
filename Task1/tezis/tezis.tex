...
{\me{ Нестеров И.Н., Клочков С.В., Чурсанова А.С.} (Воронеж)} {nesterovilyan@gmail.com, klochkov\_s.v@mail.ru}
...
$$
	...
	\end{pmatrix}.
$$
Векторами столбцами матрицы перехода являются собственные и присоединенные векторы, которые имеют вид:
\begin{multline*}
(1, \lambda_1, \ldots, \lambda_1^{n-1}), (0, 1, \ldots,(n-1)\lambda_1^{n-2}), (0, 0, \ldots, k_1!, \frac{(n-1)!}{(n-k_1)!}\lambda_1^{n-k_1}),\\ 
\shoveleft{\ldots, (1, \lambda_2, \ldots, \lambda_2^{n-1}), \ldots, (0, 0, \ldots, k_2!, \frac{(n-1)!}{(n-k_2)!}\lambda_2^{n-k_2}), \ldots,} \\
\shoveleft{ (0, 0, \ldots, k_m!, \frac{(n-1)!}{(n-k_m)!}\lambda_m^{n-k_m})}
\end{multline*}
